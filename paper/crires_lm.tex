...
\title{CRIRES$^+$ L- and M-band spectral archive with telluric-calibrated slit tilt and wavelength solutions}

\author{I.\,V.~Hartogs\inst{1}}

\institute{Department of Physics and Astronomy, Uppsala University,
  Box 516, SE-75120 Uppsala, Sweden\\
  \email{tom@placeholder.se}}
...
between September 2021 and January 2025, totalling 11\,131 raw frames
...
resolving power up to $R \approx 100\,000$, recording three detector chips
...
\citep{vipere}, a forward-modelling tool that simultaneously fits the
