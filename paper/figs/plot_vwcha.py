...
axes[0].set_title(r'VW Cha — setting M4368 — order 04')
axes[0].legend(loc='lower left', framealpha=0, fontsize=8)
axes[-1].set_xlabel(r'Wavelength [$\mu$m]')

fig.subplots_adjust(hspace=0.18)

fig.savefig('vwcha_CO.pdf', bbox_inches='tight')
fig.savefig('vwcha_CO.png', bbox_inches='tight', dpi=150)
